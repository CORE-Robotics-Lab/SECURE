...
class GaussianMLPModel(Model):
    ...
    def _build(self, state_input, name=None):
        ...
        # yy: log_std_var is the variance, increase it here TODO
        # yy: log_std_var: shape=(bs, 1, action_space_shape), mean_var: shape=(bs, 1, action_space_shape)
